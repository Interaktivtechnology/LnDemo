...
class Menu extends \yii\widgets\Menu
{
    ...
    //public $firstItemCssClass = "menu-open";
    public $activeParentClass = "";
    /**
     * @inheritdoc
     */
    ...
    {
        if(isset($item['items']))
            $linkTemplate = '<a class=" '. $this->activeParentClass .'" href="{url}">{icon} {label} </a>';
        else
