...
define("STATUS_URL", 'http://'.$_SERVER['HTTP_HOST']."/status.php");
define("RETURN_URL", 'http://'.$_SERVER['HTTP_HOST']."/result.php");
define("REGISTRATION_URL", 'http://'.$_SERVER['HTTP_HOST']."/index.php");